import {ACTIVE_CLASS, EFFECT_MOVE, PREVENT_TRANSITION_EFFECT_CLASS, WRAPPER_CLASS} from "../classes";

type Actions = {
	afterTransition:() => void
}
type MoveAction = (activeIndex: number) => void
type EffectsHandler = (slider: HTMLElement, actions:Actions) => EffectHandlerInterface
...
export type EffectsList = {
	[EFFECT_MOVE]: EffectsHandler,
}


function moveEffectHandler(slider:HTMLElement, {afterTransition}:Actions):EffectHandlerInterface {
